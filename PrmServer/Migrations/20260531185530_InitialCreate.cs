        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UtilizationPct = table.Column<int>(type: "int", nullable: false),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Allocations_Users_AllocatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HoursLogged = table.Column<float>(type: "real", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimesheetTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TimesheetTags_ActivityTags_ActivityTagId",
                        column: x => x.ActivityTagId,
                        principalTable: "ActivityTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TimesheetTags_Timesheets_TimesheetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Allocations_AllocatedBy",
                table: "Allocations",
                column: "AllocatedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimesheetTags_ActivityTagId",
                table: "TimesheetTags",
                column: "ActivityTagId");

            migrationBuilder.CreateIndex(
                name: "IX_TimesheetTags_TimesheetId",
                table: "TimesheetTags",
                column: "TimesheetId");
        }
